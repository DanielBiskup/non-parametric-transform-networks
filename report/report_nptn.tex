...
\section{Conclusion}
In the three experiments we performed using the descriptions from the paper, at least one of the NPTNs performed better than the CNN.  However the difference is most of the time not as prominent as in the paper and some NPTNs perform worse than the CNN. 
